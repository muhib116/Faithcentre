...
export default class OurMission extends React.Component
{
    ...
    fetchItems = async () => {
        const data   = await fetch(api.url("get_section_data/our-mission"));
    ...
    render(){
        ...
        return(
            <section className={classes.our_mission_section}>
                {(responseStatus!==true) ? 
                        ...
                        {result.map(item=>(
                            <div className="container" key={Math.random()}>
                                ...
                                <h2 className="section_title">{item.title}</h2>
                                    ...
                                    <Link to={`section/${item.slug}`} className={["btn danger ", classes.mission_read_more].join(' ')}>
                                ...
                                <div className={classes.right}>
                                    <LoadImage 
                                        ...
                                        alt="About Us" 
                                    />
                                    {/* <img loading="lazy"  src="my_resource/img/our_mission.webp" alt="our mission" /> */}
                                </div>
                            </div>
                        ))}
                    </>
